...
class Detector:
    """Detect Bounding box of Human"""

    def __init__(self, path, cfg, media_type="video", detector=None, tracker=None):
        self.images = []
        ...
        stream = cv2.VideoCapture(path)  # test
        # stream = cv2.VideoCapture(int(path))
