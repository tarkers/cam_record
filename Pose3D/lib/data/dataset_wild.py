...
def read_input_from_dict(results, vid_size, scale_range, focus):
    kpts_all = []
    for item in results:
        if focus!=None and item['idx']!=focus:
            continue
...
class PoseDataset(Dataset):
    def __init__(self,  clip_len=243, vid_size=None, scale_range=None, focus=None):
        self.clip_len = clip_len
        self.vid_all = read_input_from_dict( vid_size, scale_range, focus)
